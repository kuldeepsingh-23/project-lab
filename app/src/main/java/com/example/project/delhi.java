...
public class delhi extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if(v==i1)
        {
            startActivity(new Intent(this,delhiinfo.class));
        }
        else if (v==i2)
        {
             startActivity(new Intent(this,delhimap.class));
        }
        else if (v==i3)
        {
          startActivity(new Intent(this,delhihotel.class));
        }
        else if(v==i4)
        {
            startActivity(new Intent(this,delhirestrau.class));
        }
